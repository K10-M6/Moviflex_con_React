...
import viajeEnCarro from "../Imagenes/viaje-en-carro1.jpg";
import DNNYPYGT65C3JHMUEEZKEUM7AY from "../Imagenes/DNNYPYGT65C3JHMUEEZKEUM7AY.jpg";
import salirACarreteraGonhergo from "../Imagenes/salir-a-carretera-gonhergo.jpg";
...
const BackgroundSlider = ({ images = [], interval = 6000, overlayColor = 'rgba(18,76,131,0.45)' }) => {
  ...
  useEffect(() => {
    ...
    setFade(true);
    const timeout = setTimeout(() => setFade(false), interval - 1000); // Start fade out 1s before change
    const t = setInterval(() => {
      setFade(true);
      setTimeout(() => {
...
function Profile() {
  ...
  // Imágenes importadas para el slider de fondo
  ...
  return (
    <div style={{ minHeight: '100vh', minWidth: '100vw', position: 'relative' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2 }}>
        ...
        {/* Card de edición semitransparente */}
          {/* Header y edición en la misma fila */}
